...
/**
 * User: Jeff Yu Date: 1/04/11
 */
public class ManagementClient {

	// Used for authentication.
	//private static final String authentication_form_url = "http://localhost:8080/business-central-server/rs/";
	//private static final String authentication_form_url   = "http://localhost:8080/business-central-server/rs/process/definition/org.jbpm.evaluation.carinsurance.quote/instances";
	private static final String authentication_form_url   = "http://localhost:8080/business-central-server/rs/process/definition/org.jbpm.evaluation.carinsurance.quote/new_instance";
	private static final String authentication_submit_url = "http://localhost:8080/business-central-server/rs/identity/secure/j_security_check";
	...
	private static final String instance_url = "http://localhost:8080/business-central-server/rs/process/definition/org.jbpm.evaluation.carinsurance.quote/instances";
	
	// Show Historic Process Instance.
	private static final String history_search_url = "http://localhost:8080/business-central-server/rs/process/definition/";

	// Show Tasks.
	private static final String tasks_url = "http://localhost:8080/business-central-server/rs/tasks/admin/participation";
	
	//private static final String execute_task_url = "http://localhost:8080/business-central-server/rs/process/definition/org.jbpm.evaluation.carinsurance.quote/new_instance";
	private static final String execute_task_url = "http://localhost:8080//business-central-server/rs/form/process/org.jbpm.evaluation.carinsurance.quote/complete";
...
//
	...
	public void getHistoricProcessInstance() throws Exception 
	{
		...
		// http://localhost:8080/business-central-server/rs/process/definition/history/org.jbpm.evaluation.carinsurance.quote/nodeInfo
	...
	private HttpMethodWrapper httpWrapper = new HttpMethodWrapper();
