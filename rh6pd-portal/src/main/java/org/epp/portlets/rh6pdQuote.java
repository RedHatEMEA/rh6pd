...
/**
 * {@link rh6pdQuote} is the JSF backing bean for the application, holding the input data to be re-displayed.
 */
@ManagedBean(name = "rh6pdQuote")
@SessionScoped
public class rh6pdQuote implements Serializable {
